...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Aakash Verma, a passionate Full stack developer and problem
          solver. Currently, I&apos;m the Tech Team Lead at Cloud web solution , and
          I&apos;m pursuing a MBA degree in I.T online at
          Amity Univercity  in Nodia , India, with an expected
          graduation year of 2021. I&apos;m a software developer with experience
          in TypeScript, TailwindCSS, and JavaScript. I specialize in frameworks
          such as React, Node.js, Next.js,React-Native React-Three-Fiber, and Three.js. My
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:akagujjar1@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
          href="document/akash_verma_Resume.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
